  ...
  render() {
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          <SocialLogo imgURL={githubImg} alternate="Github" redirectURL="https://github.com/sweetphea" />
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="mailto:salimatahagbadou@gmail.com" />
          <SocialLogo imgURL={linkedInImg} alternate="Linkedin" redirectURL="https://www.linkedin.com/in/salimatahagbadou" />
        </SocialMediaIcons>
      </Container>
    );
  }
